...
class TestKycandy():
  ...
  def test_kycandy(self):
    ...
    elementlogin.click()
    self.driver.find_element(By.ID, "email").send_keys("amydv06test1@mail.com")
    self.driver.find_element(By.ID, "password").send_keys("Cotest1234=")
...
#     self.driver.find_element(By.NAME, "kyc[home_phone_number]").send_keys("(999) 222-3333" ) #Home 
#     # self.driver.find_element(By.NAME, "kyc[cell_phone_number]").click()
#     self.driver.find_element(By.NAME, "kyc[cell_phone_number]").send_keys("(999) 444-5555") #Cell
#     # self.driver.find_element(By.NAME, "kyc[work_phone_number]").click()
#     self.driver.find_element(By.NAME, "kyc[work_phone_number]").send_keys("(999) 666-7777") #Work
#     self.driver.find_element(By.ID, "kyc_next_button").click()
# #####################################
...
#     self.driver.find_element(By.NAME, "militaryIncome[military_division]").send_keys("US Navy")
#     Select(self.driver.find_element(By.NAME, "militaryIncome[start_date][0]")).select_by_value('SEPTEMBER')
#     Select(self.driver.find_element(By.NAME, "militaryIncome[start_date][1]")).select_by_value('1')
#     Select(self.driver.find_element(By.NAME, "militaryIncome[start_date][2]")).select_by_value('1999')

#     self.driver.find_element(By.ID, "add_military_income").click()
#     self.driver.find_element(By.NAME, "militaryIncome[base_income]").send_keys("7680")
#     self.driver.find_element(By.NAME, "militaryIncome[housing_allowance]").send_keys("776")
