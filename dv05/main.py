...
class TestKycandy():
  ...
  def test_kycandy(self):
    ...
    elementlogin.click()
    self.driver.find_element(By.ID, "email").send_keys("alicedv05@mail.com") # maindv01@mail.com
...
#####################################
    ...
    self.driver.find_element(By.NAME, "current_address[street]").send_keys("9991 Waterford Street")
    ...
    Select(self.driver.find_element(By.NAME, "current_address[years]")).select_by_value('1')
    Select(self.driver.find_element(By.NAME, "current_address[months]")).select_by_value('0')
    ...
    self.driver.find_element(By.ID, "add_former_address_button").click()
    self.driver.find_element(By.NAME, "former_addresses[0][street]").send_keys("158 21st Street")
    self.driver.find_element(By.NAME, "former_addresses[0][city]").send_keys("Dawson")
    self.driver.find_element(By.NAME, "former_addresses[0][zipcode]").send_keys("50066")
    Select(self.driver.find_element(By.NAME, "former_addresses[0][years]")).select_by_value('1')
    Select(self.driver.find_element(By.NAME, "former_addresses[0][months]")).select_by_value('0')
    Select(self.driver.find_element(By.NAME, "former_addresses[0][housing]")).select_by_value('NO PRIMARY HOUSING EXPENSE')
    self.driver.find_element(By.ID, "kyc_next_button").click()
####################################
...
#####################################
    ...
    WebDriverWait(self.driver, 5).until(ec.visibility_of_element_located((By.ID, "kyc_next_button")))
    self.driver.find_element(By.NAME, "current_employments[0][employer_name]").send_keys("Employer One")
    # self.driver.find_element(By.NAME, "current_employments[0][position]").click()
    self.driver.find_element(By.NAME, "current_employments[0][position]").send_keys("Administrator")
    # self.driver.find_element(By.NAME, "current_employments[0][phone]").click()
    self.driver.find_element(By.NAME, "current_employments[0][phone]").send_keys("4444444444")
    # self.driver.find_element(By.NAME, "current_employments[0][street]").click()
    self.driver.find_element(By.NAME, "current_employments[0][street]").send_keys("9988 Main Street")
    ...
    self.driver.find_element(By.NAME, "current_employments[0][base_income]").send_keys("9051")
...
#####################################
    ...
    self.driver.find_element(By.NAME, "assets[0][account_number]").send_keys("9492")
    # self.driver.find_element(By.NAME, "assets[0][market_value]").click()
    self.driver.find_element(By.NAME, "assets[0][market_value]").send_keys("6000")
    ...
    self.driver.find_element(By.NAME, "assets[1][account_number]").send_keys("9223")
    # self.driver.find_element(By.NAME, "assets[1][market_value]").click()
    self.driver.find_element(By.NAME, "assets[1][market_value]").send_keys("2600")

    ####### 2nd asset #######
    WebDriverWait(self.driver, 5).until(ec.visibility_of_element_located((By.ID, "btn_add_asset")))
    self.driver.find_element(By.ID, "btn_add_asset").click()
    Select(self.driver.find_element(By.NAME, "assets[2][account_type]")).select_by_value('CHECKING') 
    self.driver.find_element(By.NAME, "assets[2][financial_institution]").send_keys("BankA")
    # self.driver.find_element(By.NAME, "assets[2][account_number]").click()
    self.driver.find_element(By.NAME, "assets[2][account_number]").send_keys("1564351465")
    # self.driver.find_element(By.NAME, "assets[2][market_value]").click()
    self.driver.find_element(By.NAME, "assets[2][market_value]").send_keys("500")
    ...
    self.driver.find_element(By.NAME, "liabilities[0][unpaid_balance]").send_keys("2500")
    ...
    # self.driver.find_element(By.NAME, "assets[3][account_number]").click()
    self.driver.find_element(By.NAME, "liabilities[1][account_number]").send_keys("8641157")
    # self.driver.find_element(By.NAME, "assets[3][market_value]").click()
...
####################################
    ...
    self.driver.find_element(By.ID, "add_gifts_or_grants").click()
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[0][asset_type]")).select_by_value('CASH GIFT')
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[0][deposited]")).select_by_value('DEPOSITED')
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[0][gift_source]")).select_by_value('RELATIVE')
    self.driver.find_element(By.NAME, "gifts_mortgages[0][market_value]").send_keys("1000")

    self.driver.find_element(By.ID, "add_gifts_or_grants").click()
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[1][asset_type]")).select_by_value('GIFT OF EQUITY')
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[1][deposited]")).select_by_value('NOT DEPOSITED')
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[1][gift_source]")).select_by_value('RELATIVE')
    self.driver.find_element(By.NAME, "gifts_mortgages[1][market_value]").send_keys("4500")

    self.driver.find_element(By.ID, "add_gifts_or_grants").click()
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[2][asset_type]")).select_by_value('GRANT')
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[2][deposited]")).select_by_value('NOT DEPOSITED')
    Select(self.driver.find_element(By.NAME, "gifts_mortgages[2][gift_source]")).select_by_value('LOCAL AGENCY')
    self.driver.find_element(By.NAME, "gifts_mortgages[2][market_value]").send_keys("2000")
...
#####################################
    ...
    self.driver.find_element(By.NAME, "property_address[street]").send_keys("1234 Main St")
    ...
    # Step 23 Purchase
    WebDriverWait(self.driver, 5).until(ec.visibility_of_element_located((By.ID, "kyc_next_button")))
    self.driver.find_element(By.NAME, "property_address[street]").send_keys("2422 Knapps Ways")
    self.driver.find_element(By.NAME, "property_address[state]").send_keys("IA")
    self.driver.find_element(By.NAME, "property_address[city]").send_keys("Dawson")
    self.driver.find_element(By.NAME, "property_address[zipcode]").send_keys("50066")
    Select(self.driver.find_element(By.NAME, "property_address[occupancy]")).select_by_value('PR')
    Select(self.driver.find_element(By.NAME, "property_address[property_type]")).select_by_value('SFR')
    ...
    self.driver.find_element(By.NAME, "property_address[loan_amount]").send_keys("168875")
    self.driver.find_element(By.ID, "kyc_next_button").click()
#####################################
