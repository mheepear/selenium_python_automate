...
class TestAmy():
  ...
  def test_amy(self):
    ...
    # Authentication
    WebDriverWait(self.driver, 5).until(ec.visibility_of_element_located((By.LINK_TEXT, "Log in"))).click()
    self.driver.find_element(By.LINK_TEXT, "Log in").click()
    self.driver.find_element(By.ID, "email").send_keys("amyfreddie@freddiemac.com")
    ...
    # Step Fullname
    self.driver.find_element(By.NAME, "kyc[first_name]").send_keys("Amy")
